...
function handleEvent(event) {
    ...
    if(event.message.text.toLowerCase() == "hai"){
      ...
      return client.replyMessage(event.replyToken, balesan);
    }else if(event.message.text.toLowerCase() == "foto frelly"){
      const bales = {
                  type: 'image',
                  originalContentUrl: "https://cdn.glitch.com/53ae1b8b-acad-4031-99f3-c24f2119b5ab%2FAFACF8E0-9CFE-4756-8086-B93914B89731.png?v=1615221153069",
                  previewImageUrl: "https://cdn.glitch.com/53ae1b8b-acad-4031-99f3-c24f2119b5ab%2FAFACF8E0-9CFE-4756-8086-B93914B89731.png?v=1615221153069",
                  size: "full"
                };
      return client.replyMessage(event.replyToken, bales);
    }else if(event.message.text.toLowerCase() == "foto syah"){
      const bales = {
                  type: 'image',
                  originalContentUrl: "https://cdn.glitch.com/53ae1b8b-acad-4031-99f3-c24f2119b5ab%2F128570.jpg?v=1615214246708",
                  previewImageUrl: "https://cdn.glitch.com/53ae1b8b-acad-4031-99f3-c24f2119b5ab%2F128570.jpg?v=1615214246708",
                  size: "full"
                };
      return client.replyMessage(event.replyToken, bales);
    }else if(event.message.text.toLowerCase() == "foto syah"){
